...
def main_tests():
    ...
    test_array1 = SortedArray()  # initialise a LinearArray
    process_file(filename, test_array1)
    print('Processing', filename, 'with a sorted array')
    test_array2 = LinearArray()  # initialise a LinearArray
    process_file(filename, test_array2)
    linear_time = time_linear_trial(filename)
    sorted_time = time_sorted_trial(filename)
